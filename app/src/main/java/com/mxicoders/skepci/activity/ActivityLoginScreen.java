...
public class ActivityLoginScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (tv_patient.getText().toString().equals("Patient")){

            user_type = tv_patient.getText().toString();

        }else {

            user_type = tv_phys.getText().toString();
        }
    ...
    private void SignIn() {
        ...
        if (!cc.isConnectingToInternet()) {
            ...
            AndyUtils.showToast(ActivityLoginScreen.this,getString(R.string.no_internet));
        } else if (!AndyUtils.eMailValidation(edtUser.getText().toString())) {
