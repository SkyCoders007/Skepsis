...
//    android.app.FragmentTransaction tra;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url_compare4 = "http://mbdbtechnology.com/projects/skepsi/ws/sleep_data/sleep_data/" + pid;
        ...
        lnQuestionnaries.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*Intent narticle = new Intent(ActivityMenuPatientList.this, QuestionnariesPatientActivity.class);
