...
*/
        ...
        if (tv_male.getText().equals("Male")){
       ...
       /* customAdapter=new SpinnerAdapter(ActivitySignUpPsychologist.this,day);
        spDay.setAdapter(customAdapter);

        customAdapter=new SpinnerAdapter(ActivitySignUpPsychologist.this,month);
        spMonth.setAdapter(customAdapter);

        customAdapter=new SpinnerAdapter(ActivitySignUpPsychologist.this,year);
...
//            gotoNextActivity(name,email,pass,convertDay,convertMonth,convertYear);
...
//            printDateInMyFormat(convertDay,convertMonth,convertYear);
    ...
    private void gotoNextActivity(String name, String email, String pass, String dateInString) {
       ...
       /* startActivity(new Intent(ActivitySignUpPsychologist.this, ActivitySignupPhyschologistTwo.class)
                .putExtra("name", name)
                .putExtra("email", email)
                .putExtra("password", pass)
                .putExtra("b_day",convertDay)
