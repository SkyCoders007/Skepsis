...
public class ActivitySignupPatientTwo extends AppCompatActivity {
   ...
   /* String convertDay;
    ...
    private void gotoFinalstep(String name, String email, String password,
        ...
        /*startActivity(new Intent(ActivitySignupPatientTwo.this, ActivitySignupPatientThree.class)
                .putExtra("name", name)
                .putExtra("email", email)
                .putExtra("password", password)
                .putExtra("city",city)
    ...
    /*private void printDateInMyFormat(String convertDay, String convertMonth, String convertYear) {
