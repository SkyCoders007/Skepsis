...
public class EditProfilePatientActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        if (tv_patient_male.getText().equals("Male")){

            gender = tv_patient_male.getText().toString();

        }else {

            gender = tv_patient_female.getText().toString();
        }
...
//                                    date = dateInString;
    ...
    private void ChangePassword() {
        ...
        if (!cc.isConnectingToInternet()) {
            ...
            AndyUtils.showToast(this,"Please enter old password");
        } else if (newPass.equals("")) {
            AndyUtils.showToast(this,"Please enter new password");
        } else if (confirmNewPass.equals("")) {
            AndyUtils.showToast(this,"Please enter Confirm new password");
        } else if (!confirmNewPass.matches(newPass)) {
            AndyUtils.showToast(this,"New password and Confirm new password must be same");
        } else {
