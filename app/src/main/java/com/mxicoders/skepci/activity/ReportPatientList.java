...
public class ReportPatientList extends AppCompatActivity {
    ...
    String note = "Notes";
    String coping_card = "Coping card";
    String questionnaries = "Questionaries";
    ...
    private void createPdf(View v){
       ...
       /* int totalHeight = wv_description.getChildAt(0).getHeight();
        ...
        try {
            ...
            document.close();
            out.close();
            Toast.makeText(this, "Pdf downloded successfully to /sdcard/skepsisreport/", Toast.LENGTH_LONG).show();
    ...
    private void firstTimeStartWebview(String currentDate, String nextDate, String patientID) {
        ...
        strUrlDateChange = "http://mbdbtechnology.com/projects/skepsi/ws/Report/Report_view/"+patientID.trim()+"/"+"Mood"+"/"+currentDate.trim()+"/"+nextDate.trim();
    ...
    private void popUpDialog() {
        ...
        String[] type = new String[]{"Mood","Sleep","Emotions","Coping card","Notes","Questionaries"};
        ...
        tv_submit_int_dialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              String end = tv_end_date.getText().toString().trim();
                ...
                if(start.matches("([0-9]{1,2})/([0-9]{2})/([0-9]{4})") && end.matches("([0-9]{1,2})/([0-9]{2})/([0-9]{4})")){
                    ...
                    if (startDate.after(endDate))
                    {
                        ...
                        cc.showToast("Please select correct date");
    ...
    private void webViewStart(String start, String end, String selectedType, String patientID) {
        ...
        if (selectedType.equals("Mood")){

            strUrlDateChange = "http://mbdbtechnology.com/projects/skepsi/ws/Report/Report_view/"+patientID.trim()+"/"+selectedType.trim()+"/"+start.trim()+"/"+end.trim();
        ...
        }else if (selectedType.equals("Sleep")){
        ...
        }else if (selectedType.equals("Emotions")){
        ...
        }else if (selectedType.equals("Coping card")){

            Log.e("Coping card",".......");

            getCopingCard(start,end);

        }else if (selectedType.equals("Notes")){

            Log.e("Notes",".........");

            getNote(start,end);
        }else if (selectedType.equals("Questionaries")){
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(jsonObject.getString("status").equals("200")){
                                ...
                                if (jsonObject.getString("message").equals("Record not found")){
