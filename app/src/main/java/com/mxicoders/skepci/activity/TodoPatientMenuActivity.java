...
//    ArrayList<ToDoData> list,list2,list3;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        list3.add(new ToDoData("RPD",currentDate,dayOfTheWeek));
                        ...
                        try {
                            ...
                            if (jsonObject.getString("status").equals("200")) {
                                ...
                                for (int i = 0; i < dataArray.length(); i++) {
                                    ...
                                    if (jsonObject1.getString("assign_date").equals(Todays_currentDate) && jsonObject1.getString("status").equals("Undone")) {
                                    ...
                                    } else if (jsonObject1.getString("assign_date").equals(preDate) && jsonObject1.getString("status").equals("Undone")) {
                                        ToDoListData model = new ToDoListData();
