                        ...
                        public void onCheckedChanged(RadioGroup group, int checkedId) {
                            switch(checkedId){
                                ...
                                case R.id.rb_primary_emotion:
                                    ...
                                    radio_part = ((RadioButton)dialog.findViewById(r_part.getCheckedRadioButtonId())).getText().toString();
                        ...
                        public void onCheckedChanged(RadioGroup group, int checkedId) {
                            switch(checkedId){
                                case R.id.rb_once:
                                    ...
                                    radio_e_schedule = ((RadioButton)dialog.findViewById(r_e_schedule.getCheckedRadioButtonId())).getText().toString();;
                        ...
                        public void onCheckedChanged(RadioGroup group, int checkedId) {
                            switch(checkedId){
                                ...
                                case R.id.rb_primary_emotion:
                                    ...
                                    radio_e_level = ((RadioButton)dialog.findViewById(r_e_level.getCheckedRadioButtonId())).getText().toString();
